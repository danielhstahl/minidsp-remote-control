...
describe.sequential("login scenarios", () => {
  ...
  test("login after requireAuth with existing key", async () => {
    ...
    const [firstInvocation] = statusSpy.mock
      .calls as unknown as StatusInput[][];
